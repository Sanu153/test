...
import com.poditivity.chat.adapter.UsersAdapter

import com.poditivity.chat.databinding.FragmentUsersBinding
    ...
    private fun searchUser(query: String) {
        ...
        client.queryUsers(request).enqueue { result ->
            if (result.isSuccess) {
                ...
                Log.e("UsersFragment", result.errorOrNull()!!.message.toString())
            }
        }
    }
